...
const inputVariants = tv({
  base: [
    "flex h-9 w-full appearance-none rounded border-0 border-border bg-surface px-3 py-1 text-start text-sm outline-0 transition-opacity [-webkit-tap-highlight-color:transparent]",
